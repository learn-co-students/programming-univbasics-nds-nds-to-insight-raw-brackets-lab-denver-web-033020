...
# and total up all the
 ...
 name_index = 0
 #this the creation of the hash that records directors name as key and total gross movie as value
          result = {}
#this loop pulls directos name
          while name_index < nds.length do
            directors_name = nds[name_index][:name]
            result[directors_name] = 0
            movie_index = 0
#this loop goes through each name hash and pulls the worldwide_gross 
          while movie_index < nds[name_index][:movies].length do
            result[directors_name] += nds[name_index][:movies][movie_index][:worldwide_gross]
            movie_index += 1 
        end
        name_index += 1
        end
