...
def directors_totals(nds)
  ...
  director_movies = 0
  total = 0
  while director_movies < directors_database[director_index][:movies].length do 
  total += directors_database[director_index][:movies][director_movies][:worldwide_gross]
  
  director_movies += 1
end 
names = directors_database[director_index][:name]
  puts names
  puts total
  hash[directors_database[director_index][:name]] = total
#    result = {names => total
 # }
  hash
  director_index += 1 
